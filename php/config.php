...
$empfaenger = "anne.dalchow@web.de";  // Ihre E-Mail Adresse (zwischen den Anführungszeichen) Bei Problemen: https://www.kontaktformular.com/faq-script-php-kontakt-formular.html#keine-mail-erhalten

$ihrname = "Anne Dalchow";  // Ihr Name (zwischen den Anführungszeichen)

$cfg['Datenschutz_Erklaerung'] = 1;  //  0 = Ohne Datenschutzerklärung    1 = Mit Datenschutzerklärung

$datenschutzerklaerung = "../datenschutz.html";  //  Pfad zur Datenschutzerklärung. "datenschutz.php" kann durch einen Link/URL ersetzt werden. (muss mit "http://www." anfangen!)
...
$cfg['Links'] = 1;  //  Anzahl der maximal erlaubten Links (0 = keine Links erlaubt)
...
$cfg['Badwordfields'] = 'vorname, name, telefon, email, betreff, nachricht';  //   Die Namen der Felder, die bei dem Bad Word Filter geprüft werden sollen - Groß- und Kleinschreibung beachten!
...
$cfg['NUM_ATTACHMENT_FIELDS'] = 1;	// Anzahl der Upload-Felder
